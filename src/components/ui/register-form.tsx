			...
			>
				<div className=" container   mx-auto">
					<div className=" my-4 py-10 ">
						<h2 className=" text-3xl font-semibold text-gray-900">Регистрация</h2>
						...
						<div className="flex flex-col-reverse justify-center lg:flex-row">
							<div className="mt-10 w-full lg:w-9/12 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
								...
								<div className="sm:col-span-3">
									...
									></label>
									<div className="mt-2">
										<FormInput name="email" label="Адрес электронной почты" required />
									</div>
								</div>
								<div className="sm:col-span-3">
									<label
													...
													<FormItem>
														<Select onValueChange={field.onChange} defaultValue={field.value}>
															...
															<SelectContent>
																...
																<SelectItem value="QUALIFYING">Отборочный</SelectItem>
								...
								<div className="sm:col-span-3">
									...
									></label>
									<div className="mt-2">
										<FormInput name="organisation" label="Организация" required />
									</div>
								</div>
							...
							<img src="../registr.png" className="mx-auto mt-10 h-1/4 w-2/12" />
						</div>
					</div>
				</div>
			</form>
